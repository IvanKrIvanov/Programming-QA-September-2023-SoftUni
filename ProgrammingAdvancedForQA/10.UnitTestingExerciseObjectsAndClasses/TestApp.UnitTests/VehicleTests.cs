...
public class VehicleTests
{
    ...
    [Test]
    public void Test_AddAndGetCatalogue_ReturnsEmptyCatalogue_WhenOnlyCarsGiven()
    {
        // Arrange
        Vehicles vehicles = new Vehicles();
        string[] input =
    ...
    [Test]
    public void Test_AddAndGetCatalogue_ReturnsEmptyCatalogue_WhenOnlyTrucksGiven()
    {
        // Arrange
        Vehicles vehicles = new Vehicles();
        string[] input =
