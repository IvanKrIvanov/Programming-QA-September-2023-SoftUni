...
public class SongTests
{
    ...
    public void Test_AddAndListSongs_ReturnsFilteredSongs_WhenWantedListIsSpecific()
    {
        ...
        string typeToSearch = "Rock";

        // Act
        string result = this._song.AddAndListSongs(songs, typeToSearch);
    ...
    [Test]
    public void Test_AddAndListSongs_ReturnEmptyString_WhenNoSongsAreGiven()
    {
        // Arrange
        string[] songs = { };

        // Act
        string result = this._song.AddAndListSongs(songs, "Hip-Hop");
